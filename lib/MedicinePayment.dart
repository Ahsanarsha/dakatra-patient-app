...
class _MedicinePaymentState extends State<MedicinePayment> {
  ...
  void initState() {
    ...
    // PayStack //
    plugin.initialize(publicKey: MySharedPreferenceHelper.getString(Preferences.payStack_public_key)!);
  }
  ...
  getBookedData() async {
    grandTotal = MySharedPreferenceHelper.getInt('grandTotal');
    pharmacyId = MySharedPreferenceHelper.getInt('pharmacyIdCart');
    prescriptionFilePath = MySharedPreferenceHelper.getString('prescriptionFilePath');
  ...
  _getAddress() async {
    setState(
      () {
        address = (MySharedPreferenceHelper.getString('Address'));
        addressId = (MySharedPreferenceHelper.getInt('addressId'));
        userLat = MySharedPreferenceHelper.getString('lat');
        userLang = MySharedPreferenceHelper.getString('lang');
        //user data
        userPhoneNo = MySharedPreferenceHelper.getString('phone_no');
        userEmail = MySharedPreferenceHelper.getString('email');
      },
    );
  }
  ...
  getDistance() async {
    ...
    MySharedPreferenceHelper.setString('strFinalDeliveryCharge', strFinalDeliveryCharge!);
                                        ...
                                        Container(
                                          ...
                                          child: deliveryType == 'Home'
                                              ? ElevatedButton(
                                                  ...
                                                  onPressed: () {
                                                    MySharedPreferenceHelper.setString('isWhere', "MedicinePayment");
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      '$discountGrandTotal' == "0.0" || '$discountGrandTotal' == "0"
                                          ? Text(
                                              MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() +
                                                  grandTotal.toString(),
                            ...
                            Padding(
                              ...
                              child: Container(
                                  child: '$newGrandTotal' == "0.0" || '$newGrandTotal' == "0"
                                      ? Text(
                                          MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$payAmount',
                                          style: TextStyle(
                                            fontSize: 35,
                                            fontWeight: FontWeight.bold,
                                            color: Palette.blue,
                                      ...
                                      : Text(
                                          MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$newGrandTotal',
                                          style: TextStyle(
                                            fontSize: 35,
                                            fontWeight: FontWeight.bold,
                                            color: Palette.blue,
  ...
  beginPayment() async {
    final Flutterwave flutterwave = Flutterwave.forUIPayment(
      ...
      encryptionKey: MySharedPreferenceHelper.getString(Preferences.flutterWave_encryption_key)!,
  ...
  Future<String> callApiBookMedicine() async {
    Dio dio = Dio();
    String? t = MySharedPreferenceHelper.getString(Preferences.auth_token);
