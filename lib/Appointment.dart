...
class _AppointmentState extends State<Appointment>
                  ...
                  SliverAppBar(
                    ...
                    bottom: TabBar(
                      tabs: <Tab>[
                        Tab(
                          child: Text(
                            getTranslated(context, appointment_title_tab1)
                                .toString(),
                            style: TextStyle(
                              fontSize: 15,
                              color: Palette.blue,
                        ...
                        Tab(
                          child: Text(
                            getTranslated(context, appointment_title_tab2)
                                .toString(),
                            style: TextStyle(
                              fontSize: 15,
                              color: Palette.blue,
                        ...
                        Tab(
                          child: Text(
                            getTranslated(context, appointment_title_tab3)
                                .toString(),
                            style: TextStyle(
                              fontSize: 15,
                              color: Palette.blue,
                          ...
                          child: Container(
                            child: ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                var status = '';
                                if (pendingAppointment[index]
                                        .appointmentStatus!
                                        .toUpperCase() ==
                                    'PENDING') {
                                  statusColor =
                                      Palette.dark_blue.withOpacity(0.6);
                                  status = getTranslated(
                                          context, appointment_pending)
                                      .toString();
                                } else if (pendingAppointment[index]
                                        .appointmentStatus!
                                        .toUpperCase() ==
                                    'CANCEL') {
                                  statusColor = Palette.red;
                                  status =
                                      getTranslated(context, appointment_cancel)
                                          .toString();
                                } else if (pendingAppointment[index]
                                        .appointmentStatus!
                                        .toUpperCase() ==
                              ...
                              itemBuilder: (context, index) {
                                ...
                                if (upcomingAppointment[index]
                                  ...
                                  status = getTranslated(
                                          context, appointment_pending)
                                      .toString();
                                } else if (upcomingAppointment[index]
                                        .appointmentStatus!
                                        .toUpperCase() ==
                                    'CANCEL') {
                                  statusColor = Palette.red;
                                            ...
                                            builder: (context) =>
                                              ...
                                              doctorImage:
                                                  pastAppointment[index]
                                                      .doctor!
                                                      .fullImage,
                                              doctorName: pastAppointment[index]
                                                  .doctor!
                                                  .name,
                                              doctorTreatmentName:
                                                  pastAppointment[index]
                                              ...
                                              appointmentDate:
                                                  pastAppointment[index].date,
                                              appointmentTime:
                                                  pastAppointment[index].time,
                                              patientName:
                                                  pastAppointment[index]
                                                      .patientName,
                                              appointmentIdPrescription:
                                                  pastAppointment[index]
                                                      ...
                                                      : 0,
                                              appointmentId:
                                                  pastAppointment[index].id,
                                              userRating:
                                                  pastAppointment[index].rate,
                                            ),
                                          ),
                                        );
                                      },
  ...
  Future<BaseModel<CancelAppointment>> callApiCancelAppointment() async {
    ...
    try {
      response =
          await RestClient(RetroApi().dioData()).cancelAppointmentRequest(body);
      if (response.success == true) {
        setState(() {
