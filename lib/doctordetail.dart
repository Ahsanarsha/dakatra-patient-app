                                ...
                                children: [
                                  Container(
                                    margin: EdgeInsets.symmetric(
                                        vertical: width * 0.005),
                                    child: Text(
                                      getTranslated(context, offer_discount)
                                          .toString(),
                                      style: TextStyle(
                                          fontSize: width * 0.035,
                                          color: Colors.red[900],
                            ...
                            child: new TabBar(
                              ...
                              tabs: [
                                ...
                                Tab(
                                  child: Text(
                                    getTranslated(
                                            context, doctorDetail_tab2_title)
                                        .toString(),
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                ...
                                //   child: Text(
                                //     getTranslated(
                                //             context, doctorDetail_tab3_title)
                                //         .toString(),
                                //     textAlign: TextAlign.center,
                                //   ),
                                // ),
