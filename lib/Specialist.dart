                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          hintText: getTranslated(
                                  context, specialist_searchDoctor_hint)
                              .toString(),
                          hintStyle: TextStyle(
                            fontSize: width * 0.04,
                            color: Palette.dark_blue,
          ...
          child: _searchResult.length > 0 || _search.text.isNotEmpty
              ? _searchResult.length != 0
                                              ...
                                              Stack(
                                                children: [
                                                  ...
                                                  Positioned(
                                                    ...
                                                    right: 0,
                                                    child: Container(
                                                      child: MySharedPreferenceHelper
                                                                  .getBoolean(
                                                                      Preferences
                                                                          .is_logged_in) ==
                                                              true
                  ...
                  : Container(
                      ...
                      child: Text(
                        getTranslated(context, specialist_doctorNotFound)
                            .toString(),
                        style: TextStyle(
                            fontSize: width * 0.04,
                            color: Palette.grey,
