              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      getTranslated(context, medicineOrderDetail_orderSummary).toString(),
                      style: TextStyle(fontSize: 22, color: Palette.dark_blue, fontWeight: FontWeight.bold),
                    ),
                  ),
                ),
                Padding(
                            ...
                            Row(
                              ...
                              children: [
                                      ...
                                      Container(
                                        child: Text(
                                          MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() +
                                              bookMedicineList![index].price.toString(),
                                          style: TextStyle(
                                            fontSize: 16,
                                            color: Palette.dark_blue,
                                          ),
                                ...
                                Padding(
                                  ...
                                  child: Container(
                                    child: Text(
                                      MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$medicineAmountTotal',
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Palette.dark_blue,
                                      ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(
                              MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$totalAmount',
                              style: TextStyle(fontSize: 18, color: Palette.dark_blue, fontWeight: FontWeight.bold),
                            ),
                          )
                        ],
                        ...
                        children: [
                          ...
                          Container(
                            child: deliveryCharge != null
                                ? Text(
                                    MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$deliveryCharge',
                                    style: TextStyle(fontSize: 18, color: Palette.dark_blue, fontWeight: FontWeight.bold),
                                  )
                                : Text(
                                    '0',
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Container(
                              child: Text(
                                MySharedPreferenceHelper.getString(Preferences.currency_symbol).toString() + '$grandTotal',
