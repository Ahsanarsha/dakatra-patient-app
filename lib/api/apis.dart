...
class Apis {
  static const String baseUrl =
      "https://dakattra.com/api/"; //Please don't remove "/api/".
  // static const String  baseUrl                = "https://doctoraswan.com/api/";  //Please don't remove "/api/".
  static const String login = "login";
  static const String register = "register";
  static const String doctors_list = "doctors";
  static const String   selected_doctors = "doctors";
  static const String hospitals_list = "hospitals";
