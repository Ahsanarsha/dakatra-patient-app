...
class _RestClient implements RestClient {
  _RestClient(this._dio, {this.baseUrl}) {
    baseUrl ??= 'https://dakattra.com/api/';
  }
  ...
  Future<Doctors> doctorList(body) async {
    ...
    log('_result.data!. 11111111155');
    log(json.encode(_result.data!));
    final value = Doctors.fromJson(_result.data!);
    return value;
  }

  @override
  Future<Doctors> selectedDoctors(body) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = body;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Doctors>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, Apis.selected_doctors,
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
