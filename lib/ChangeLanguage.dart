...
class _ChangeLanguageState extends State<ChangeLanguage> {
          ...
          child: Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                // this.value = 0;
                value = Language.languageList()[index].name == MySharedPreferenceHelper.getString(Preferences.current_language_code)
                    ? index
                    : null;
                if (MySharedPreferenceHelper.getString(Preferences.current_language_code) == 'N/A') {
                  this.value = 1;
                }
                return Padding(
                      ...
                      child: RadioListTile(
                        ...
                        onChanged: (int? val) async {
                          ...
                          setState(() {
                            ...
                            MySharedPreferenceHelper.setString(Preferences.current_language_code, Language.languageList()[index].name);
  ...
  Future<BaseModel<UpdateProfile>> callApiUpdateProfile() async {
    ...
    Map<String, dynamic> body = {
      ...
      "dob": userDateOfBirth,
      "gender": userGender,
      "language": MySharedPreferenceHelper.getString(Preferences.current_language_code),
    };
    setState(() {
      loading = true;
    });
