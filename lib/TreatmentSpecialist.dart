  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: PreferredSize(
        preferredSize: Size(width * 0.3, size.height * 0.18),
        child: SafeArea(
          top: true,
          child: Container(
            child: Column(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      '$treatmentSpecialist' +
                          " " +
                          getTranslated(
                                  context, treatmentSpecialist_specialistDoctor)
                              .toString(),
                      style: TextStyle(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child:
                                                                ...
                                                                alignment:
                                                                    Alignment
                                                                        .center,
                                                                imageUrl: treatmentSpecialistList[
                                                                        index]
                                                                    .fullImage!,
                                                                fit:
                                                                    BoxFit.fill,
  ...
  Future<BaseModel<TreatmentWishDoctor>> callApiTreatmentWishDoctor() async {
    ...
    try {
      response = await RestClient(RetroApi2().dioData2())
          .treatmentWishDoctorRequest(id, body);
      setState(() {
